...
async function main() {
  // Executa o SQL via função RPC (precisa da extensão pg_net ou execute_sql habilitada)
  // Alternativamente, use o painel do Supabase para rodar esse SQL se der erro aqui
  try {
